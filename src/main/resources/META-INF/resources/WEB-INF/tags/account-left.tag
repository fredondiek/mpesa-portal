...
<%@attribute name="account" type="org.crunhbits.app.core.account.domain.Account" required="true" %>
<%@attribute name="vacationDaysLeft" type="org.crunhbits.app.core.account.domain.VacationDaysLeft"
             required="true" %>
